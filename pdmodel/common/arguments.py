...
def parse_args():
    ...
    parser.add_argument('-hypo', '--num-hypotheses', default=5, type=int, help='number of hypotheses')
    ...
    parser.add_argument('--warmup', default=0, type=int, metavar='N', help='warm-up epochs for semi-supervision')
